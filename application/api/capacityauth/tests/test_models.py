...
from api.capacityauth import models
from api.capacityauth.models import CapacityAuthDosUser, validate_dos_username_exists
...
#     "Test validate dos_username_exists_model function validator"
    ...
    def test_validate_dos_username_exists__no_validator_errors(self, mock_logger, mock_get_dos_user_for_username):
        ...
        mock_logger.debug.assert_called_with("DoS user exists with values: %s", mock_get_dos_user_for_username.return_value)
    ...
    def test_validate_dos_username_exists__not_active_error(self, mock_logger, mock_get_dos_user_for_username):
        ...
        with self.assertRaises(ValidationError):
            try:
                ...
                self.assertEqual(["Username '" + stub_dos_username + "' is not an 'ACTIVE' DoS user"], e.messages)
                raise e
    ...
    @mock.patch.object(models, "get_dos_user_for_username")
    @mock.patch.object(models,"logger")
    def test_validate_dos_username_exists__username_does_not_exist_error(self, mock_logger, mock_get_dos_user_for_username):
        ...
        with self.assertRaises(ValidationError):
            try:
                ...
                self.assertEqual(["Username '" + stub_dos_username + "' does not exist in DoS"], e.messages)
                raise e
    ...
    @mock.patch.object(models, "get_dos_user_for_username")
    @mock.patch.object(models,"logger")
    def test_validate_dos_username_exists__multiple_users_with_username_error(self, mock_logger, mock_get_dos_user_for_username):
        ...
        with self.assertRaises(ValidationError):
            try:
                ...
                self.assertEqual(["Unexpected multiple DoS users with given username '" + stub_dos_username + "'"], e.messages)
                raise e
...
#     "Test CapacityAuthDosUser model class method"
    ...
    @mock.patch("api.capacityauth.models.super")
    @mock.patch.object(models, "get_dos_user_for_username")
